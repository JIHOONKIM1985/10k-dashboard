...
const RateDisplaySection: React.FC<RateDisplaySectionProps> = ({
  ...
  return (
    <div className="mt-8 px-2 sm:px-0">
      ...
      {/* 모바일: flex-row 3분할, PC: grid-cols-3 */}
      <div className="flex flex-row gap-3 w-full justify-between sm:grid sm:grid-cols-3 sm:gap-6">
        <div className="w-[30%] max-w-xs sm:w-auto bg-[#18181b] rounded-2xl shadow-lg p-4 sm:p-6 flex flex-col items-center text-white border border-white/10">
